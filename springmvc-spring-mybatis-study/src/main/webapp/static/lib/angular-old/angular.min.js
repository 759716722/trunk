...
(function (S, U, s) {
    ...
    function v(b) {
        return function () {
            var a = arguments[0],
                c,
                a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.20/" + (b ? b + "/" : "") + a;
    ...
    function q(b, a, c) {
        var d;
        if (b) if (O(b)) for (d in b)"prototype" == d || ("length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d)) || a.call(c, b[d], d);
    ...
    function eb() {
        for (var b = ja.length,
            ...
            b--;
            a = ja[b].charCodeAt(0);
            if (57 == a) return ja[b] = "A",
                ja.join("");
            if (90 == a) ja[b] = "0";
            else return ja[b] = String.fromCharCode(a + 1),
                ja.join("")
        }
        ja.unshift("0");
        return ja.join("")
    ...
    function Ga(b, a, c, d) {
        ...
        if (a) {
            ...
            if (L(b)) for (var g = a.length = 0; g < b.length; g++) e = Ga(b[g], null, c, d),
            T(b[g]) && (c.push(b[g]), d.push(e)),
                ...
                for (g in b) e = Ga(b[g], null, c, d),
                T(b[g]) && (c.push(b[g]), d.push(e)),
                    a[g] = e;
                Xb(a, f)
            }
        } else(a = b) && (L(b) ? a = Ga(b, [], c, d) : Oa(b) ? a = new Date(b.getTime()) : fb(b) ? a = RegExp(b.source) : T(b) && (a = Ga(b, {},
            c, d)));
        return a
    }
    ...
    function ka(b, a) {
        if (L(b)) {
            ...
            b) !gb.call(b, c) || "$" === c.charAt(0) && "$" === c.charAt(1) || (a[c] = b[c]);
        return a || b
    }
    ...
    function zb(b, a) {
        ...
        return !O(a) || a instanceof RegExp ? a : c.length ?
            function () {
    ...
    function ga(b) {
        ...
        try {
            return 3 === b[0].nodeType ? I(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,
                function (a, b) {
                    return "<" + I(b)
                })
        } catch (d) {
        ...
        q(d,
            function (a) {
                if (!e) {
                    ...
                    b ? (e = a, g = (b[2] || "").replace(/\s+/g, ",")) : q(a.attributes,
                        function (b) {
    ...
    function kc(b, a) {
        var c = b.ng339,
            d = Ya[c];
        d && (a ? delete Ya[c].data[a] : (d.handle && (d.events.$destroy && d.handle({},
            "$destroy"), lc(b)), delete Ya[c], b.ng339 = s))
    }

    function la(b, a, c) {
        var d = b.ng339,
            d = Ya[d || -1];
        if (B(c)) d || (b.ng339 = d = ++ne, d = Ya[d] = {}),
            d[a] = c;
        else return d && d[a]
    }
    ...
    function oc(b) {
        for (var a = 0,
                 c = b.childNodes; a < c.length; a++) Ia(c[a]);
    ...
    function rc(b) {
        var a, c;
        "function" === typeof b ? (a = b.$inject) || (a = [], b.length && (c = b.toString().replace(pe, ""), c = c.match(qe), q(c[1].split(re),
            function (b) {
                b.replace(se,
                    function (b, c, d) {
                        a.push(d)
    ...
    function te(b, a, c, d) {
        ...
        k.url = function (a, c) {
            ...
            if (a) {
                if (K != a) return K = a,
                    d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), X.attr("href", X.attr("href"))) : (z = a, c ? h.replace(a) : h.href = a),
                    k
        ...
        k.cookies = function (a, b) {
            var d, e, g, k;
            if (a) b === s ? m.cookie = escape(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : y(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + C).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            else {
                if (m.cookie !== ea) for (ea = m.cookie, d = ea.split("; "), M = {},
                                              g = 0; g < d.length; g++) e = d[g],
                    k = e.indexOf("="),
                0 < k && (a = unescape(e.substring(0, k)), M[a] === s && (M[a] = unescape(e.substring(k + 1))));
                return M
            }
        };
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function (a, b) {
                        ...
                        if (!F(b)) return a in m || f++,
                            m[a] = b,
                        f > h && this.remove(n.key),
                            b
                    },
                    get: function (a) {
                        if (h < Number.MAX_VALUE) {
    ...
    function fc(b, a) {
        ...
        this.directive = function m(a, e) {
            Ba(a, "directive");
            y(a) ? (Bb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler",
                function (b, d) {
                    var e = [];
                    q(c[a],
                        function (c, g) {
            ...
            function (a, b, l, p, n, r, t, J, w, u, K, X) {
                ...
                function N(a, b, c, d, e, g) {
                    function f(a, c, d, e) {
                        ...
                        t = p = 0;
                        for (n = m.length; p < n; t++) h = w[t],
                            c = m[p++],
                            g = m[p++],
                            l = x(h),
                            c ? (c.scope ? (r = a.$new(), l.data("$scope", r)) : r = a, l = c.transcludeOnThisElement ? M(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? M(a, b) : null, c(g, r, h, d, l)) : g && g(a, h.childNodes, s, e)
                    }

                    for (var m = [], h, l, r, p, n = 0; n < a.length; n++) h = new Kb,
                        l = ea(a[n], [], h, 0 === n ? d : s, e),
                    (g = l.length ? H(l, a[n], h, b, c, null, [], [], g) : null) && g.scope && da(x(a[n]), "ng-scope"),
                        h = g && g.terminal || !(r = a[n].childNodes) || !r.length ? null : N(r, g ? (g.transcludeOnThisElement || !g.templateOnThisElement) && g.transclude : b),
                        m.push(g, h),
                        p = p || g || h,
                        g = null;
                    return p ? f : null
                ...
                function ea(a, b, c, d, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            a = a.className;
                            if (y(a) && "" !== a) for (; m = g.exec(a);) l = ma(m[2]),
                        ...
                        case 8:
                            try {
                                if (m = e.exec(a.nodeValue)) l = ma(m[1]),
                                ca(b, l, "M", d, f) && (c[l] = aa(m[2]))
                            } catch (z) {
                            }
                    }
                    b.sort(F);
                ...
                function H(a, c, d, e, g, f, m, p, n) {
                    ...
                    function K(a, e, g, f, n) {
                        ...
                        for (z = m.length; f < z; f++) try {
                            D = m[f],
                                D(D.isolateScope ? C : e, Q, u, D.require && J(D.directiveName, D.require, Q, ea), nb)
                        } catch (G) {
                            l(G, ga(Q))
                        }
                        f = e;
                    ...
                    for (var u = -Number.MAX_VALUE,
                             ...
                             v = d.$$element = x(c), G, na, W, S = e, R, P = 0, oa = a.length; P < oa; P++) {
                        G = a[P];
                        var V = G.$$start,
                            Y = G.$$end;
                        V && (v = C(c, V, Y));
                        ...
                        if (W = G.scope) X = X || G,
                        G.templateUrl || (I("new/isolated scope", M, G, v), T(W) && (M = G));
                        na = G.name;
                        !G.templateUrl && G.controller && (W = G.controller, N = N || {},
                            I("'" + na + "' controller", N[na], G, v), N[na] = G);
                        if (W = G.transclude) F = !0,
                        G.$$tlb || (I("transclusion", ca, G, v), ca = G),
                            "element" == W ? (Da = !0, u = G.priority, W = C(c, V, Y), v = d.$$element = x(U.createComment(" " + na + ": " + d[na] + " ")), c = v[0], ob(g, x(za.call(W, 0)), c), S = z(W, e, u, f && f.name, {
                ...
                function ca(b, e, g, f, h, r, p) {
                    ...
                    if (c.hasOwnProperty(e)) {
                        ...
                        e = a.get(e + d);
                        for (var t = 0,
                                 w = e.length; t < w; t++) try {
                            n = e[t],
                            (f === s || f > n.priority) && -1 != n.restrict.indexOf(g) && (r && (n = Yb(n, {
                                $$start: r,
                                $$end: p
                            })), b.push(n), h = n)
                        } catch (J) {
                ...
                function A(a, b, c, d, e, g, f, m) {
                    ...
                    b.empty();
                    p.get(u.getTrustedResourceUrl(K), {
                        cache: n
                    }).success(function (p) {
                        var n, u;
                        p = Z(p);
                            ...
                            compile: function () {
                                return {
                                    pre: function (c, d, m) {
                                        ...
                                        if (g = b(m[e], !0, S(a, e))) m[e] = g(c),
                                            (d[e] || (d[e] = [])).$$inter = !0,
                                            (m.$$observers && m.$$observers[e].$$scope || c).$watch(g,
                                                function (a, b) {
            ...
            function (a, b, c, d, p, n) {
                ...
                function t(c, g, f) {
                    ...
                    if (D) if (H = D.get(x), B(H)) {
                        if (H.then) return H.then(t, t),
                            H;
                        L(H) ? n(H[1], H[0], ka(H[2]), H[3]) : n(H, 200, {},
                            "OK")
                    } else D.put(x, q);
    ...
    function we(b, a, c, d, e) {
        function g(a, b, c) {
            ...
            8 >= P && (g.onreadystatechange = function () {
                y(g.readyState) && /loaded|complete/.test(g.readyState) && (g.onreadystatechange = null, f({
                    type: "load"
                }))
            });
        ...
        return function (e, m, h, l, p, n, r, t) {
            ...
            if ("jsonp" == I(e)) {
                ...
                var X = g(m.replace("JSON_CALLBACK", "angular.callbacks." + K), K,
                    function (a, b) {
                        w(l, a, d[K].data, "", b);
                        d[K] = A
                    })
    ...
    function Sd() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce",
            function (c, d, e) {
                function g(g, h, l) {
                    for (var p, n, r = 0,
                             t = [], J = g.length, w = !1, u = []; r < J;) -1 != (p = g.indexOf(b, r)) && -1 != (n = g.indexOf(a, p + f)) ? (r != p && t.push(g.substring(r, p)), t.push(r = c(w = g.substring(p + f, n))), r.exp = w, r = n + k, w = !0) : (r != J && t.push(g.substring(r)), r = J);
                    (J = t.length) || (t.push(""), J = 1);
                    if (l && 1 < t.length) throw yc("noconcat", g);
                    if (!h || w) return u.length = J,
                        r = function (a) {
                            try {
                                for (var b = 0,
                                         c = J,
                                         f; b < c; b++) {
                                    if ("function" == typeof(f = t[b])) if (f = f(a), f = l ? e.getTrusted(l, f) : e.valueOf(f), null == f) f = "";
    ...
    function Bc(b, a) {
        ...
        this.$$rewrite = function (d) {
            var e;
            if ((e = pa(b, d)) !== s) return d = e,
                (e = pa(a, e)) !== s ? c + (pa("/", e) || e) : b + d;
                ...
                g.on("click",
                    function (a) {
                        if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                            for (var e = x(a.target);
                                 "a" !== I(e[0].nodeName);) if (e[0] === g[0] || !(e = e.parent())[0]) return;
                            var f = e.prop("href");
                            T(f) && "[object SVGAnimatedString]" === f.toString() && (f = ta(f.animVal).href);
                            if (m === Qb) {
                                var h = e.attr("href") || e.attr("xlink:href");
                                if (0 > h.indexOf("://")) if (f = "#" + b, "/" == h[0]) f = p + f + h;
    ...
    function rb(b, a, c, d, e) {
        ...
        for (var g, f = 0; 1 < a.length; f++) {
            ...
            k || (k = {},
                b[g] = k);
            b = k;
            b.then && e.unwrapPromises && (ua(d), "$$v" in b ||
            function (a) {
                a.then(function (b) {
                    a.$$v = b
                })
    ...
    function Ec(b, a, c) {
        ...
        if (a.csp) g = 6 > e ? Dc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
            var f = 0,
                k;
            do k = Dc(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g),
                g = s,
                b = k;
            while (f < e);
            return k
                ...
                k.prototype = {
                    ...
                    $watchCollection: function (a, b) {
                        ...
                        return this.$watch(function () {
                                d = m(c);
                                var a, b;
                                if (T(d)) if (db(d)) for (e !== l && (e = l, q = e.length = 0, h++), a = d.length, q !== a && (h++, e.length = q = a), b = 0; b < a; b++) e[b] !== e[b] && d[b] !== d[b] || e[b] === d[b] || (h++, e[b] = d[b]);
                                else {
                                    e !== n && (e = n = {},
                                        q = 0, h++);
                                    a = 0;
                        ...
                        do {
                            ...
                            a: do {
                                if (k = N.$$watchers) for (q = k.length; q--;) try {
                                    if (d = k[q]) if ((g = d.get(N)) !== (f = d.last) && !(d.eq ? ya(g, f) : "number" === typeof g && "number" === typeof f && isNaN(g) && isNaN(f))) z = !0,
                                        c = d,
                                        d.last = d.eq ? Ga(g, null) : g,
                                        d.fn(g, f === p ? g : f, N),
                                    5 > s && (x = 4 - s, M[x] || (M[x] = []), C = O(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, C += "; newVal: " + sa(g) + "; oldVal: " + sa(f), M[x].push(C));
                                    else if (d === c) {
                                        z = !1;
                                        break a
                                    }
                    ...
                    $destroy: function () {
                        if (!this.$$destroyed) {
                            ...
                            this !== n && (q(this.$$listenerCount, zb(null, l, this)), a.$$childHead == this && (a.$$childHead = this.$$nextSibling), a.$$childTail == this && (a.$$childTail = this.$$prevSibling), this.$$prevSibling && (this.$$prevSibling.$$nextSibling = this.$$nextSibling), this.$$nextSibling && (this.$$nextSibling.$$prevSibling = this.$$prevSibling), this.$parent = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = this.$root = null, this.$$listeners = {},
                                this.$$watchers = this.$$asyncQueue = this.$$postDigestQueue = [], this.$destroy = this.$digest = this.$apply = A, this.$on = this.$watch = function () {
                                return A
                            })
                        }
                    },
                    ...
                    $broadcast: function (a, b) {
                        for (var c = this,
                                 ...
                                 f = [g].concat(za.call(arguments, 1)), k, h; c = d;) {
                            g.currentScope = c;
                            d = c.$$listeners[a] || [];
                            k = 0;
    ...
    function ce() {
        this.$get = ["$window", "$document",
            function (b, a) {
                var c = {},
                    d = Z((/android (\d+)/.exec(I((b.navigator || {}).userAgent)) || [])[1]),
    ...
    function Mc(b, a, c, d, e) {
        ...
        if (h) 0 < e && ( -1 < b && 1 > b) && (k = b.toFixed(e));
            ...
            var l = 0,
                p = a.lgSize,
                n = a.gSize;
            if (f.length >= p + n) for (l = f.length - p, h = 0; h < l; h++) 0 === (l - h) % n && 0 !== h && (k += c),
                k += f.charAt(h);
            for (h = l; h < f.length; h++) 0 === (f.length - h) % p && 0 !== h && (k += c),
                k += f.charAt(h);
            for (; b.length < e;) b += "0";
    ...
    function Oc(b, a, c, d) {
        ...
        g.$setValidity = function (a, b, c) {
            var d = m[a];
            if (b) d && (Qa(d, c), d.length || (k--, k || (e(b), g.$valid = !0, g.$invalid = !1), m[a] = !1, e(!0, a), f.$setValidity(a, !0, g)));
            else {
                k || e(b);
                if (d) {
                    if (-1 != Pa(d, c)) return
    ...
    function xb(b, a, c, d, e, g) {
        ...
        var l = function (e) {
            if (!h) {
                var g = a.val();
                if (P && "input" === (e || m).type && a[0].placeholder !== k) k = a[0].placeholder;
                else if (Sa(c.ngTrim || "T") && (g = aa(g)), e = f && d.$$hasNativeValidators, d.$viewValue !== g || "" === g && e) b.$$phase ? d.$setViewValue(g) : b.$apply(function () {
                    d.$setViewValue(g)
                })
            }
        };
    ...
    q({
            ...
            attr: function (b, a, c) {
                var d = I(a);
                if (mb[d]) if (B(c)) c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d));
                else return b[a] || (b.attributes.getNamedItem(a) || A).specified ? d : s;
            ...
            html: function (b, a) {
                ...
                for (var c = 0,
                         d = b.childNodes; c < d.length; c++) Ia(d[c]);
                b.innerHTML = a
            },
            empty: oc
        },
        function (b, a) {
            R.prototype[a] = function (a, d) {
                ...
                if (b !== oc && (2 == b.length && b !== Jb && b !== nc ? a : d) === s) {
                    if (T(a)) {
                        for (e = 0; e < f; e++) if (b === mc) b(this[e], a);
                    ...
                    function (d) {
                        ...
                        if (!g) {
                            if ("mouseenter" == d || "mouseleave" == d) {
                                var l = U.body.contains || U.body.compareDocumentPosition ?
                                    function (a, c) {
    ...
    var ue = /^(x[\:\-_]|data[\:\-_])/i,
        ...
        Ob = v("$location");
    Qb.prototype = Pb.prototype = Bc.prototype = {
        $$html5: !1,
        $$replace: !1,
        absUrl: qb("$$absUrl"),
        url: function (a, c) {
    ...
    Sb.prototype = {
        ...
        readIdent: function () {
            for (var a = this,
                     c = "",
                     d = this.index,
                     e, g, f, k; this.index < this.text.length;) {
            ...
            if (cb.hasOwnProperty(c)) d.fn = cb[c],
                d.literal = !0,
                d.constant = !0;
            else {
        ...
        readString: function (a) {
            ...
            for (var d = "",
                     e = a,
                     g = !1; this.index < this.text.length;) {
                var f = this.text.charAt(this.index),
                    e = e + f;
                if (g)"u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Pe[f]) ? d + g : d + f,
                    g = !1;
                else if ("\\" === f) g = !0;
                else {
                    if (f === a) {
    ...
    var Rc = function (a) {
        ...
        Na = "ng-pristine",
        wb = "ng-dirty",
        Ue = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate",
            function (a, c, d, e, g, f) {
                ...
                this.$setViewValue = function (d) {
                    ...
                    this.$modelValue !== d && (this.$modelValue = d, h(a, d), q(this.$viewChangeListeners,
                        function (a) {
                            try {
                                a()
                            } catch (d) {
                        ...
                        c.$watch(e.ngIf,
                            function (g) {
                                Sa(g) ? m || (m = c.$new(), f(m,
                                    ...
                                    })) : (h && (h.remove(), h = null), m && (m.$destroy(), m = null), k && (h = Cb(k.clone), a.leave(h,
                                    function () {
                                        h = null
                                    }), k = null))
                            })
                    ...
                    link: function (e, g, f, k, m) {
                        ...
                        e.$watchCollection(k,
                            function (a) {
                                ...
                                C = y.length;
                                k = F.length = y.length;
                                for (f = 0; f < k; f++) if (H = a === y ? f : y[f], v = a[H], v = p(H, v, f), Ba(v, "`track by` id"), B.hasOwnProperty(v)) A = B[v],
                                    delete B[v],
                                    u[v] = A,
                                    F[f] = A;
                                else {
                                    if (u.hasOwnProperty(v)) throw q(F,
                                        function (a) {
                                            a && a.scope && (B[a.id] = a)
                                        }),
                                        d("dupes", h, v);
                                ...
                                for (H in B) B.hasOwnProperty(H) && (A = B[H], f = Cb(A.clone), c.leave(f), q(f,
                                    function (a) {
                                        a.$$NG_REMOVED = !0
                                    }), A.scope.$destroy());
                                f = 0;
                    ...
                    link: function (c, d, e, g) {
                        ...
                        c.$watch(e.ngSwitch || e.on,
                            function (d) {
                                ...
                                k.length = 0;
                                h.length = 0;
                                if (f = g.cases["!" + d] || g.cases["?"]) c.$eval(e.change),
                                    q(f,
                                        function (d) {
                                            var e = c.$new();
                                            h.push(e);
                    ...
                    link: function (e, f, k, m) {
                        ...
                        function p(e, f, g) {
                            function k() {
                                ...
                                s = !1;
                                var E, I;
                                if (r) if (w && L(t)) for (s = new Za([]), C = 0; C < t.length; C++) Q[m] = t[C],
                                    s.put(w(e, Q), t[C]);
                                else s = new Za(t);
                                for (C = 0; F = D.length, C < F; C++) {
                                    ...
                                    r ? d = B(s.remove(w ? w(e, Q) : q(e, Q))) : (w ? (d = {},
                                        d[m] = t, d = w(e, d) === w(e, Q)) : d = t === q(e, Q), s = s || d);
                                    E = l(e, Q);
                                    E = B(E) ? E : "";
                                    h.push({
                                        id: w ? w(e, Q) : n ? D[C] : C,
                                ...
                                for (D = c.length; Q < D; Q++) {
                                    ...
                                    y.length <= Q ? (t = {
                                        ...
                                        z = [t], y.push(z), f.append(t.element)) : (z = y[Q], t = z[0], t.label != d && t.element.attr("label", t.label = d));
                                    E = null;
                                    C = 0;
                                    for (F = h.length; C < F; C++) s = h[C],
                                        (d = z[C + 1]) ? (E = d.element, d.label !== s.label && E.text(d.label = s.label), d.id !== s.id && E.val(d.id = s.id), d.selected !== s.selected && E.prop("selected", d.selected = s.selected)) : ("" === s.id && v ? I = v : (I = u.clone()).val(s.id).prop("selected", s.selected).text(s.label), z.push({
                                            element: I,
                                            label: s.label,
                                            id: s.id,
                                            selected: s.selected
                                    ...
                                    e.$apply(function () {
                                        ...
                                        if (r) for (k = [], p = 0, u = y.length; p < u; p++) for (a = y[p], l = 1, t = a.length; l < t; l++) {
                                            if ((h = a[l].element)[0].selected) {
                                                h = h.val();
                                                n && (d[n] = h);
                                                if (w) for (v = 0; v < c.length && (d[m] = c[v], w(e, d) != h); v++);
                                                else d[m] = c[h];
                                                k.push(q(e, d))
                                            }
                                        } else {
    ...
    S.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : ((Ca = S.jQuery) && Ca.fn.on ? (x = Ca, E(Ca.fn, {
        scope: Ka.scope,
        isolateScope: Ka.isolateScope,
        controller: Ka.controller,
        injector: Ka.injector,
        inheritedData: Ka.inheritedData
    }), Eb("remove", !0, !0, !1), Eb("empty", !1, !1, !1), Eb("html", !1, !1, !0)) : x = R, Ta.element = x, $c(Ta), x(U).ready(function () {
        Xc(U, cc)
    }))
})(window, document);
